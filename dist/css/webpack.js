        ...
        if (typeof rule !== "string" && rule.test instanceof RegExp && rule.test.test("test.css")) {
          rules[i] = {
            ...
            use: [
              ...
              {
                loader: "css-loader",
                options: Object.assign(Object.assign({ importLoaders: 1 }, getImportAndUrlCssLoaderOptions(nextConfig)), {
                  modules: {
                    auto: true,
  ...
  rules === null || rules === void 0
    ...
    : rules.push({
        ...
        use: [
          ...
          {
            loader: "css-loader",
            options: Object.assign(Object.assign({ importLoaders: 3 }, getImportAndUrlCssLoaderOptions(nextConfig)), {
          ...
          "resolve-url-loader",
          {
            ...
            options: {
              ...
              additionalData:
                ((_b = nextConfig.sassOptions) === null || _b === void 0 ? void 0 : _b.prependData) ||
 ...
 */
const getImportAndUrlCssLoaderOptions = (nextConfig) =>
  isCssLoaderV6()
    ? {
        url: {
...
const getUrlResolver = (nextConfig) => (url, resourcePath) => {
  var _a;
  return (0, file_resolve_1.cssFileResolve)(url, resourcePath, (_a = nextConfig.experimental) === null || _a === void 0 ? void 0 : _a.urlImports);
};
const getImportResolver = (nextConfig) => (url, _, resourcePath) => {
  var _a;
  return (0, file_resolve_1.cssFileResolve)(
    typeof url === "string" ? url : url.url,
    resourcePath,
    (_a = nextConfig.experimental) === null || _a === void 0 ? void 0 : _a.urlImports
  );
};
const isCssLoaderV6 = () => {
  try {
